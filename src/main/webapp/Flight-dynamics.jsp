                ...
                <div class="search_style">
                    <ul class="search_content clearfix">
                        ...
                        <li>
                            ...
                            <input  type="date" class="inline laydate-icon" id="start" style=" margin-left:10px;">
                        </li>
                        <li>
            ...
            <div class="table_menu_list">
                <table class="table table-striped table-bordered table-hover" id="sample-table">
                    ...
                    <tr>
                        ...
                        <td class="text-l">${flightRecord.attribute}波音</td>
                        <td>${flightRecord.nature}国内机型</td>
                        <td>${flightRecord.airlportStart}南昌机</td>
                        <td>${flightRecord.planTakeTime}</td>
                        <td>${flightRecord.planLandTime}</td>
                        <td>${flightRecord.airportEnd}天河机场</td>
                        <td class="td-status"><span class="label label-success radius">${flightRecord.flightStatus}正常</span></td>
